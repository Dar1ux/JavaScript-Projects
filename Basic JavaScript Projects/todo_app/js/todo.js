...
function add() {
    ...
    var todos = get_todos();
    // this adds a new task input to JSON string
    todos.push(task);
...
// this will allow to add tasks with "Enter" key press on input element
...
// this will keep the input displayed permanently on the screen
show();
