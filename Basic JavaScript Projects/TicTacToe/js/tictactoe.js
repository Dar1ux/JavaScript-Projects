...
function placeXorO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        // squareNumber and activePlayer are concatinated together and added to array.
        ...
        if (activePlayer === 'O') {
            ...
            disableClick();
            // This function waits 1 second before placeing the image
            // and enabling click.
    ...
    function computersTurn() {
        ...
        while (!success) {
            ...
            // If the random number evaluates retruns true, the square hasn't been selected yet.
...
function checkWinConditions() {
    ...
    // This condition checks for tie. If none of the above condintions register
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        // The next 3 variables will be used to check 3 in a row.
...
// This function takes a string parameter of the path you set earliear for
